...
| **Membre 34** | Développeur CRUD (Suppression)           | Implémente `delete_materiel()` avec confirmation avant suppression. Gère les erreurs liées aux identifiants inexistants.                                               |
